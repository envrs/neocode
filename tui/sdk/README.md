# Neocode Go API Library

<a href="https://pkg.go.dev/neocode-sdk-go"><img src="https://pkg.go.dev/badge/neocode-sdk-go.svg" alt="Go Reference"></a>
...
```go
import (
	"neocode-sdk-go" // imported as neocode
)
```
...
```sh
go get -u 'neocode-sdk-go@v0.1.0-alpha.8'
```
...
See the [full list of request options](https://pkg.go.dev/neocode-sdk-go/option).
...
We are keen for your feedback; please open an [issue](https://www.neocode-sdk-go/issues) with questions, bugs, or suggestions.

...
import (
	...
	"neocode-sdk-go/internal"
	"neocode-sdk-go/internal/apierror"
	"neocode-sdk-go/internal/apiform"
	"neocode-sdk-go/internal/apiquery"
	"neocode-sdk-go/internal/param"
)

func getDefaultHeaders() map[string]string {
	return map[string]string{
		"User-Agent": fmt.Sprintf("Neocode/Go %s", internal.PackageVersion),
	}
}

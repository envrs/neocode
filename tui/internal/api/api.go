...
func Start(ctx context.Context, program *tea.Program, client *neocode.Client) {
	for {
		select {
		case <-ctx.Done():
			return
...
func Reply(ctx context.Context, client *neocode.Client, response interface{}) tea.Cmd {
	return func() tea.Msg {

...
import (
	...
	"github.com/neopilot-ai/neocode/internal/api"
	"github.com/neopilot-ai/neocode/internal/app"
	"github.com/neopilot-ai/neocode/internal/commands"
	"github.com/neopilot-ai/neocode/internal/completions"
	"github.com/neopilot-ai/neocode/internal/components/chat"
	cmdcomp "github.com/neopilot-ai/neocode/internal/components/commands"
	"github.com/neopilot-ai/neocode/internal/components/dialog"
	"github.com/neopilot-ai/neocode/internal/components/fileviewer"
	"github.com/neopilot-ai/neocode/internal/components/modal"
	"github.com/neopilot-ai/neocode/internal/components/status"
	"github.com/neopilot-ai/neocode/internal/components/toast"
	"github.com/neopilot-ai/neocode/internal/layout"
	"github.com/neopilot-ai/neocode/internal/styles"
	"github.com/neopilot-ai/neocode/internal/theme"
	"github.com/neopilot-ai/neocode/internal/util"
)
...
func (a Model) Init() tea.Cmd {
	...
	// https://github.com/neopilot-ai/neocode/issues/127
	if !util.IsWsl() {
...
func (a Model) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case dialog.CompletionDialogCloseMsg:
		a.showCompletionDialog = false
	case neocode.EventListResponseEventInstallationUpdated:
		return a, toast.NewSuccessToast(
			"neocode updated to "+msg.Properties.Version+", restart to apply.",
			toast.WithTitle("New version installed"),
		)
	case neocode.EventListResponseEventIdeInstalled:
		return a, toast.NewSuccessToast(
			"Installed the neocode extension in "+msg.Properties.Ide,
			toast.WithTitle(msg.Properties.Ide+" extension installed"),
		)
	case neocode.EventListResponseEventSessionDeleted:
		if a.app.Session != nil && msg.Properties.Info.ID == a.app.Session.ID {
			a.app.Session = &neocode.Session{}
			a.app.Messages = []app.Message{}
		}
		return a, toast.NewSuccessToast("Session deleted successfully")
	case neocode.EventListResponseEventSessionUpdated:
		if msg.Properties.Info.ID == a.app.Session.ID {
			a.app.Session = &msg.Properties.Info
		}
	case neocode.EventListResponseEventMessagePartUpdated:
		...
		if msg.Properties.Part.SessionID == a.app.Session.ID {
			...
			if messageIndex > -1 {
				...
				partIndex := slices.IndexFunc(message.Parts, func(p neocode.PartUnion) bool {
					switch casted := p.(type) {
					case neocode.TextPart:
						return casted.ID == msg.Properties.Part.ID
					case neocode.FilePart:
						return casted.ID == msg.Properties.Part.ID
					case neocode.ToolPart:
						return casted.ID == msg.Properties.Part.ID
					case neocode.StepStartPart:
						return casted.ID == msg.Properties.Part.ID
					case neocode.StepFinishPart:
						return casted.ID == msg.Properties.Part.ID
					}
					return false
				})
	...
	case neocode.EventListResponseEventMessagePartRemoved:
	...
	case neocode.EventListResponseEventMessageRemoved:
	...
	case neocode.EventListResponseEventMessageUpdated:
		if msg.Properties.Info.SessionID == a.app.Session.ID {
			...
			if matchIndex == -1 {
				a.app.Messages = append(a.app.Messages, app.Message{
					Info:  msg.Properties.Info.AsUnion(),
					Parts: []neocode.PartUnion{},
				})
			}
		}
	case neocode.EventListResponseEventSessionError:
		switch err := msg.Properties.Error.AsUnion().(type) {
		case nil:
		case neocode.ProviderAuthError:
		...
		case neocode.UnknownError:
			slog.Error("Server error", "name", err.Name, "message", err.Data.Message)
			return a, toast.NewErrorToast(err.Data.Message, toast.WithTitle(string(err.Name)))
		}
	case neocode.EventListResponseEventFileWatcherUpdated:
...
func (a Model) openFile(filepath string) (tea.Model, tea.Cmd) {
	...
	response, err := a.app.Client.File.Read(
		context.Background(),
		neocode.FileReadParams{
			Path: neocode.F(filepath),
		},
	)
	if err != nil {

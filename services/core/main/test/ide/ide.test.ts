...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders NEOCODE_CALLER", () => {
    process.env["NEOCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode NEOCODE_CALLER", () => {
    process.env["NEOCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown NEOCODE_CALLER", () => {
    process.env["NEOCODE_CALLER"] = "unknown"

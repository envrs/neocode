...
You can add external tools to neocode using the _Model Context Protocol_, or MCP. neocode supports both:
...
You can define MCP servers in your neocode config under `mcp`.

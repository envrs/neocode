...
To debug any issues with neocode, you can check the logs or the session data
...
2. **Join our Discord**
   ...
   [**neocode.ai/discord**](https://neocode.ai/discord)
...
1. Try re-authenticating with `neocode auth login <provider>`

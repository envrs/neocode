...
export const dict = {
  ...
  "dialog.provider.neocode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von NeoCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in NeoCode zu nutzen.",
  ...
  "provider.connect.neocodeZen.line1":
    "NeoCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.neocodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.neocodeZen.visit.link": "neo.khulnasoft.com/zen",
  "provider.connect.neocodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in NeoCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in NeoCode zu nutzen.",
  ...
  "dialog.plugins.empty": "In neocode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den NeoCode-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von NeoCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem NeoCode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (neocode.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: NeoCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "NeoCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "NeoCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für NeoCode ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie NeoCode auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von NeoCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von NeoCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von NeoCode.",

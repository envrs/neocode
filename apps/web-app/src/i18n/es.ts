export const dict = {
  ...
  "dialog.provider.neocode.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por NeoCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en NeoCode.",
  ...
  "provider.connect.neocodeZen.line1":
    "NeoCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.neocodeZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.neocodeZen.visit.prefix": "Visita ",
  "provider.connect.neocodeZen.visit.link": "neo.khulnasoft.com/zen",
  "provider.connect.neocodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en NeoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en NeoCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en neocode.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de NeoCode se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de NeoCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de NeoCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (neocode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, NeoCode no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "NeoCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor NeoCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para NeoCode",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve NeoCode en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de NeoCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia NeoCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de NeoCode.",

...
import { Avatar } from "@neocode-ai/pkg-ui/avatar"
import { DiffChanges } from "@neocode-ai/pkg-ui/diff-changes"
import { HoverCard } from "@neocode-ai/pkg-ui/hover-card"
...
import { Tooltip } from "@neocode-ai/pkg-ui/tooltip"
import { getFilename } from "@neocode-ai/pkg-utils/path"
import { type Message, type Session, type TextPart, type UserMessage } from "@neocode-ai/pkg-sdk/v2/client"
import { For, Match, Show, Switch, createMemo, onCleanup, type Accessor, type JSX } from "solid-js"
import { agentColor } from "@/utils/agent"

const NEOCODE_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === NEOCODE_PROJECT_ID
              ? "https://neo.khulnasoft.com/favicon.svg"

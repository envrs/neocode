...
beforeAll(async () => {
  ...
  mock.module("@neocode-ai/pkg-ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@neocode-ai/pkg-ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@neocode-ai/pkg-ui/icon", () => ({ Icon: () => null }))
  mock.module("@neocode-ai/pkg-ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

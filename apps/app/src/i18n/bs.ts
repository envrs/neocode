export const dict = {
  ...
  "dialog.provider.neocode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje NeoCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u NeoCode-u.",
  ...
  "provider.connect.neocodeZen.line1":
    "NeoCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.neocodeZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.neocodeZen.visit.prefix": "Posjeti ",
  "provider.connect.neocodeZen.visit.link": "neo.khulnasoft.com/zen",
  "provider.connect.neocodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u NeoCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u NeoCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u neocode.json",
  ...
  "dialog.server.description": "Promijeni na koji se NeoCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija NeoCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku NeoCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (neocode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: NeoCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "NeoCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni NeoCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u NeoCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako NeoCode izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu NeoCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se NeoCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju NeoCode-a.",

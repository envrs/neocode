export const dict = {
  ...
  "dialog.provider.neocode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af NeoCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i NeoCode.",
  ...
  "provider.connect.neocodeZen.line1":
    "NeoCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.neocodeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.neocodeZen.visit.prefix": "Besøg ",
  "provider.connect.neocodeZen.visit.link": "neo.khulnasoft.com/zen",
  "provider.connect.neocodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i NeoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i NeoCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i neocode.json",
  ...
  "dialog.server.description": "Skift hvilken NeoCode-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af NeoCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til NeoCode-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (neocode.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, NeoCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "NeoCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør NeoCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for NeoCode",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan NeoCode ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan NeoCode er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når NeoCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af NeoCode.",

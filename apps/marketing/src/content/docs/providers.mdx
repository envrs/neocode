...
NeoCode uses the [AI SDK](https://ai-sdk.dev/) and [neomodels.vercel.app](https://neomodels.vercel.app) to support **75+ LLM providers** and it supports running local models.
...
The `limit` fields allow NeoCode to understand how much context you have left. Standard providers pull these from neomodels.vercel.app automatically.

...
1. Via the `NEOCODE_LOG` environment variable
...
const client = new Neocode({
  logger: logger.child({ name: 'Neocode' }),
...
We are keen for your feedback; please open an [issue](https://www.github.com/neopilot-ai/neocode-sdk-js/issues) with questions, bugs, or suggestions.

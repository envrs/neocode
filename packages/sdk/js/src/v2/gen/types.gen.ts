...
/**
 * Server configuration for neocode serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: neocode.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://neo.khulnasoft.com/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://neo.khulnasoft.com/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig

...
import { Tooltip } from "@neocode-ai/ui/tooltip"
import { getFilename } from "@neocode-ai/util/path"
import { type Message, type Session, type TextPart, type UserMessage } from "@neocode-ai/sdk/v2/client"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === NEOCODE_PROJECT_ID ? "https://neo.khulnasoft.com/favicon.svg" : props.project.icon?.override
          }

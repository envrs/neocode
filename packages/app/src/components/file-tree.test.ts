...
beforeAll(async () => {
  ...
  mock.module("@neocode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@neocode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@neocode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@neocode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

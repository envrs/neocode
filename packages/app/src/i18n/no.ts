...
export const dict = {
  ...
  "dialog.provider.neocode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av NeoCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i NeoCode.",
  ...
  "provider.connect.neocodeZen.line1":
    "NeoCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.neocodeZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.neocodeZen.visit.prefix": "Besøk ",
  "provider.connect.neocodeZen.visit.link": "neo.khulnasoft.com/zen",
  "provider.connect.neocodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i NeoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i NeoCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i neocode.json",
  ...
  "dialog.server.description": "Bytt hvilken NeoCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av NeoCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til NeoCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (neocode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at NeoCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "NeoCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør NeoCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for NeoCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan NeoCode ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan NeoCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når NeoCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av NeoCode.",

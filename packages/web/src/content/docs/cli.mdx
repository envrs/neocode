...
NeoCode is powered by the provider list at [neomodels.vercel.app](https://neomodels.vercel.app), so you can use `neocode auth login` to configure API keys for any provider you'd like to use. This is stored in `~/.local/share/neocode/auth.json`.
...
| Flag        | Description                                                  |
| ----------- | ------------------------------------------------------------ |
| `--refresh` | Refresh the models cache from neomodels.vercel.app                     |

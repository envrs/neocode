...
import copyLogoSvgLight from "../asset/lander/neocode-logo-light.svg"
import copyLogoSvgDark from "../asset/lander/neocode-logo-dark.svg"
    ...
    <section data-component="top">
      <div onContextMenu={handleLogoContextMenu}>
        <A href={language.route("/")}>
          <img data-slot="logo light" src={logoLight} alt="NeoCode" width="189" height="34" />
          <img data-slot="logo dark" src={logoDark} alt="NeoCode" width="189" height="34" />
        </A>
      </div>

...
import { BillingTable } from "@neocode-ai/console-core/schema/billing.sql.js"
...
function Success(props: SuccessData) {
  return (
    <div data-slot="success">
      <p data-slot="title">You're on the NeoCode Black waitlist</p>
      <dl data-slot="details">
        <div>
          <dt>Subscription plan</dt>
          <dd>NeoCode Black {props.plan}</dd>
        </div>
        <div>
          <dt>Amount</dt>
...
export default function BlackSubscribe() {
  ...
  return (
    <>
      <Title>Subscribe to NeoCode Black</Title>
            ...
            <Match when={true}>
              <>
                <div data-slot="plan-header">
                  <p data-slot="title">Subscribe to NeoCode Black</p>
                  <p data-slot="price">

        ...
        <div data-component="content">
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="curl">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span data-slot="command-script">
                        ...
                        <span data-slot="highlight">neo.khulnasoft.com/install</span>
                        <span> | bash</span>
                      </span>
                      <CopyStatus />
                    </button>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">neocode-ai</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">neopilot-ai/tap/neocode</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
          ...
          <section data-component="what">
            <div data-slot="section-title">
              <h3>What is NeoCode?</h3>
              <p>NeoCode is an open source agent that helps you write code in your terminal, IDE, or desktop.</p>
            </div>
            <ul>
              <li>
                <span>[*]</span>
            ...
            <div data-slot="section-title">
              ...
              <div>
                ...
                <p>
                  ...
                  <strong>{config.stats.commits}</strong> commits, NeoCode is used and trusted by over{" "}
          ...
          <section data-component="privacy">
            <div data-slot="privacy-title">
              ...
              <div>
                ...
                <p>
                  NeoCode does not store any of your code or context data, so that it can operate in privacy sensitive
          ...
          <section data-component="faq">
            ...
            <ul>
              ...
              <li>
                <Faq question="How do I use NeoCode?">
                  The easiest way to get started is to read the <a href="/docs">intro</a>.
                </Faq>
              </li>
              <li>
                <Faq question="Do I need extra AI subscriptions to use NeoCode?">
                  Not necessarily, NeoCode comes with a set of free models that you can use without creating an account.
                  Aside from these, you can use any of the popular coding models by creating a <A href="/zen">Zen</A>{" "}
                  account. While we encourage users to use Zen, NeoCode also works with all popular providers such as
              ...
              <li>
                <Faq question="Can I use my existing AI subscriptions with NeoCode?">
                  Yes, NeoCode supports subscription plans from all major providers. You can use your Claude Pro/Max,
                  ChatGPT Plus/Pro, or GitHub Copilot subscriptions. <a href="/docs/providers/#directory">Learn more</a>
                  .
                </Faq>
              </li>
              <li>
                <Faq question="Can I only use NeoCode in the terminal?">
                  Not anymore! NeoCode is now available as an app for your <a href="/download">desktop</a> and{" "}
                  <a href="/docs/web">web</a>!
                </Faq>
              </li>
              <li>
                <Faq question="How much does NeoCode cost?">
                  NeoCode is 100% free to use. It also comes with a set of free models. There might be additional costs
              ...
              <li>
                <Faq question="Is NeoCode open source?">
                  Yes, NeoCode is fully open source. The source code is public on{" "}
          ...
          <section data-component="zen-cta">
            <div data-slot="zen-cta-copy">
              ...
              <p>
                Zen gives you access to a handpicked set of AI models that NeoCode has tested and benchmarked

...
import desktopAppIcon from "../../asset/lander/neocode-desktop-icon.png"
...
export default function Download() {
  ...
  return (
    <main data-page="download">
      <Title>NeoCode | Download</Title>
      <Link rel="canonical" href={`${config.baseUrl}/download`} />
      <Meta name="description" content="Download NeoCode for macOS, Windows, and Linux" />
        ...
        <div data-component="content">
          <section data-component="download-hero">
            <div data-component="hero-icon">
              <img src={desktopAppIcon} alt="NeoCode Desktop" />
            </div>
            <div data-component="hero-text">
              <h1>Download NeoCode</h1>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g neocode-ai")}>
                <code>
                  npm i -g <strong>neocode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g neocode-ai")}>
                <code>
                  bun add -g <strong>neocode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install neopilot-ai/tap/neocode")}>
                <code>
                  brew install <strong>neopilot-ai/tap/neocode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S neocode")}>
                <code>
                  paru -S <strong>neocode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[2]</span> NeoCode Desktop (Beta)
            </div>
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask neocode-desktop")}>
                <code>
                  brew install --cask <strong>neocode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[3]</span> NeoCode Extensions
            </div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
                ...
                <a href="https://neo.khulnasoft.com/docs/ide/" data-component="action-button">
                  Install
                </a>
              </div>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[4]</span> NeoCode Integrations
            </div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
                ...
                <a href="https://neo.khulnasoft.com/docs/github/" data-component="action-button">
                  Install
                </a>
              </div>
              ...
              <div data-component="download-row">
                ...
                <a href="https://neo.khulnasoft.com/docs/gitlab/" data-component="action-button">
                  Install
                </a>
              </div>
            </div>
          ...
          <ul>
            ...
            <li>
              <Faq question="Do I need extra AI subscriptions to use NeoCode?">
                Not necessarily, but probably. You'll need an AI subscription if you want to connect NeoCode to a paid
                provider, although you can work with{" "}
                <a href="/docs/providers/#lm-studio" target="_blank">
                  local models
                </a>{" "}
                for free. While we encourage users to use <A href="/zen">Zen</A>, NeoCode works with all popular
            ...
            <li>
              <Faq question="How much does NeoCode cost?">
                NeoCode is 100% free to use. Any additional costs will come from your subscription to a model provider.
                While NeoCode works with any model provider, we recommend using <A href="/zen">Zen</A>.
              </Faq>
            </li>
            <li>
              <Faq question="What about data and privacy?">
                Your data and information is only stored when you create sharable links in NeoCode. Learn more about{" "}

...
import { Database, eq, and, isNull, sql } from "@neocode-ai/console-core/drizzle/index.js"
import { BillingTable, SubscriptionTable } from "@neocode-ai/console-core/schema/billing.sql.js"
import { Actor } from "@neocode-ai/console-core/actor.js"
import { Black } from "@neocode-ai/console-core/black.js"
          ...
          <section class={styles.root}>
            <div data-slot="section-title">
              ...
              <div data-slot="title-row">
                <p>You are subscribed to NeoCode Black for ${sub().plan} per month.</p>
                <button
                  data-color="primary"
            ...
            <div data-slot="title-row">
              <p>
                {billing()?.timeSubscriptionSelected
                  ? `We're ready to enroll you into the $${billing()?.subscriptionPlan} per month NeoCode Black plan.`
                  : `You are on the waitlist for the $${billing()?.subscriptionPlan} per month NeoCode Black plan.`}
              </p>
              <button
                data-color="danger"

    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://neo.khulnasoft.com/docs"),
            text: "NeoCode Documentation",
          }),
          await MenuItem.new({
            action: () => openUrl("https://discord.com/invite/neocode"),
            text: "Support Forum",
          }),
          await PredefinedMenuItem.new({
            item: "Separator",
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/neopilot-ai/neocode/issues/new?template=feature_request.yml"),
            text: "Share Feedback",
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/neopilot-ai/neocode/issues/new?template=bug_report.yml"),
            text: "Report a Bug",
          }),
        ],
      }),

...
```sh
go get -u 'github.com/neopilot-ai/neocode-sdk-go@v0.1.0-alpha.8'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/neopilot-ai/neocode-sdk-go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/neopilot-ai/neocode-sdk-go/issues) with questions, bugs, or suggestions.

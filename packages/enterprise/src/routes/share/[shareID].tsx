      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.khulnasoft.com/neocode-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | NeoCode</Title>
              </Show>
              <Meta name="description" content="neocode - The AI coding agent built for the terminal." />

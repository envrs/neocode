...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/neocode.git")).toEqual({ owner: "sst", repo: "neocode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/neocode")).toEqual({ owner: "sst", repo: "neocode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/neocode.git")).toEqual({ owner: "sst", repo: "neocode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/neocode")).toEqual({ owner: "sst", repo: "neocode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/neocode.git")).toEqual({ owner: "sst", repo: "neocode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/neocode")).toEqual({ owner: "sst", repo: "neocode" })
})

  ...
  async handler() {
    await App.provide({ cwd: process.cwd() }, async () => {
      ...
      async function getAppInfo() {
        ...
        // ie. https://github.com/neopilot-ai/neocode.git
        // ie. git@github.com:neopilot-ai/neocode.git
    ...
    await bootstrap({ cwd: process.cwd() }, async () => {
      ...
      async function getUserPrompt() {
        let prompt = (() => {
          ...
          if (body === "/neocode" || body === "/oc") return "Summarize this thread"
          if (body.includes("/neocode") || body.includes("/oc")) return body

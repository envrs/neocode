...
const STORAGE_KEYS = {
  THEME_ID: "neocode-theme-id",
  COLOR_SCHEME: "neocode-color-scheme",
  THEME_CSS_LIGHT: "neocode-theme-css-light",
  THEME_CSS_DARK: "neocode-theme-css-dark",
} as const
...
function applyThemeCss(theme: DesktopTheme, themeId: string, mode: "light" | "dark") {
  ...
  document.getElementById("neocode-theme-preload")?.remove()
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { defaultTheme?: string }) => {
    const [store, setStore] = createStore({
      ...
      themeId: props.defaultTheme ?? "neocode-1",
